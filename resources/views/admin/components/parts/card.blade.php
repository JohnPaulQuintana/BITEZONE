        ...
        <div class="card-body">
            <div class="d-flex">
                <div class="flex-grow-1">
                    <p class="text-truncate font-size-18 mb-2 text-primary">Patient's Record</p>
...
<div class="col-xl-3 col-md-6">
    <div class="card p-2">
        <div class="card-body">
            <div class="d-flex">
                <div class="flex-grow-1">
                    <p class="text-truncate font-size-18 mb-2 text-success">Available Title</p>
...
<div class="col-xl-3 col-md-6">
    <div class="card p-2">
        <div class="card-body">
            <div class="d-flex">
                <div class="flex-grow-1">
                    <p class="text-truncate font-size-18 mb-2 text-danger">Available Title</p>
...
<div class="col-xl-3 col-md-6">
    <div class="card p-2">
        <div class="card-body">
            <div class="d-flex">
                <div class="flex-grow-1">
                    <p class="text-truncate font-size-18 mb-2 text-info">Available Title</p>
