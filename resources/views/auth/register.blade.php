    ...
    <div class="flex gap-5 justify-between">
        ...
        <div class="flex gap-10">
            <a href="#" class="flex items-center text-2xl font-semibold text-gray-700 dark:text-white hover:text-red-500">
                ...
                {{-- <img class="w-8 h-8 mr-2" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/logo.svg" alt="logo"> --}}
                <span class="border-b-2 border-red-500 text-white">Patient's</span>   
            </a>
            <a href="#" class="flex items-center text-2xl font-semibold text-gray-700 dark:text-white hover:text-blue-700">
                ...
                {{-- <img class="w-8 h-8 mr-2" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/logo.svg" alt="logo"> --}}
                <span class="border-b-2 border-blue-400 text-white">Clinic</span>   
            </a>
        </div>
    </div>
    <div class="w-full bg-transparent rounded-lg shadow dark:border md:mt-0 sm:max-w-4xl xl:p-0 dark:bg-gray-800 dark:border-gray-700 border-4">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6" action="{{ route('register') }}" method="POST">
                ...
                <div class="grid gap-6 md:grid-cols-3">
                    ...
                    <div>
                        <label for="contact_no" class="block mb-2 text-sm font-medium text-white dark:text-white">Contact No.</label>
                    ...
                    <div>
                        <label for="coordinates" class="block mb-2 text-sm font-medium text-white dark:text-white">Location Sharing</label>
                        <input type="text" name="coordinates" id="coordinates" readonly class="border-l-8 border-blue-500 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required>
                        <x-input-error :messages="$errors->get('password_confirmation')" class="mt-2" />
                    </div>
                </div>
