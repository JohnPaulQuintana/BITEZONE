<header class="bg-red-500 border-red-300 text-white border-b-2 flex gap-2 justify-between p-2 fixed w-full z-10">
    ...
    <div class="flex gap-2">
        ...
        <h1 class="font-bold text-2xl"> BITEZONE</h1>
    ...
    <div class="flex gap-2">
        ...
        <div>
            <button id="dropdownNotificationButton" data-dropdown-toggle="dropdownNotification"
                class="relative inline-flex items-center mt-1 text-sm font-medium text-center text-white hover:text-gray-200 focus:outline-none dark:hover:text-white dark:text-gray-400"
                type="button">
            ...
            <div id="dropdownNotification"
                class="z-10 hidden w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-700"
